...
export default function CiudadLanding({ content, locale }: Props) {
 ...
 {locale === 'es'
 ? 'Desplazamiento dentro de Catalunya por confirmar en presupuesto. (incluido en el presupuesto).'
 : 'Desplaçament dins de Catalunya per confirmar al pressupost. (inclòs al pressupost).'}
 </p>
 </div>
 </section>
 ...
 <h2 className="mb-6 font-display text-3xl font-bold italic text-negro sm:text-4xl">
 {locale === 'es' ? 'Tres formatos.' : 'Tres formats.'}
 </h2>
