  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-negro">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 text-center">
        ...
        <div className="mb-3 flex items-center justify-center gap-2">
          {[...Array(11)].map((_, i) => (
            <motion.span
              ...
              style={{
                backgroundColor:
                  i % 3 === 0 ? '#F47A1F' : i % 3 === 1 ? '#F5B73C' : '#FBF1DC',
        ...
        <motion.div
          className="relative mx-auto mb-4 w-full max-w-xs sm:max-w-sm lg:mb-6 lg:max-w-md"
        ...
        <h1 className="sr-only">
          Lady Jarana — Grup en directe de pop-rock, rumba i latineig a Barcelona i Catalunya
        </h1>

        <motion.p
          className="mx-auto mb-8 max-w-sm text-[10px] font-light leading-relaxed text-crema/70 drop-shadow-md sm:text-xs lg:mb-10 lg:max-w-md lg:text-sm"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.7 }}
        >
          Grup en directe per a{' '}
          <strong className="font-semibold">casaments</strong>,{' '}
          <strong className="font-semibold">festes majors</strong> i
          esdeveniments privats a{' '}
          <strong className="font-semibold">Barcelona i tota Catalunya</strong>.
          Pop-rock, rumba i latineig en format quartet.
        </motion.p>
