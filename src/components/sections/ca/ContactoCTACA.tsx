...
export default function ContactoCTACA() {
  return (
    <section className="relative overflow-hidden bg-rojo py-24 lg:min-h-[640px] lg:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        <div className="mb-6 flex justify-center">
          <SectionNumber number="07" label="Parlem" inverted />
        </div>
        ...
        >
          Passa&apos;ns la data. <br />
          <span className="text-sol">Muntem el festarro.</span>
        </motion.h2>
        ...
        >
          WhatsApp directe, sense formularis quilomètrics. Et contestem en
          minuts amb disponibilitat i preu.
        </motion.p>
