...
import { trayectoriaCA } from '@/lib/i18nData';
...
export default function TrayectoriaCA() {
  return (
    <section
      id="eventos"
    ...
    >
      <div className="relative mx-auto max-w-7xl px-6">
        <SectionNumber number="06" label="Trajectòria" />

        <h2 className="mb-4 max-w-3xl font-display text-4xl font-bold text-negro leading-[1.05] lg:text-6xl">
          De la <span className="italic text-rojo">platja</span> a les{' '}
          <span className="italic text-naranja">festes majors</span>.
        </h2>
        <p className="mb-16 max-w-2xl font-body text-lg text-negro/80">
          En menys d&apos;un any, Lady Jarana ha demostrat la seva capacitat
          d&apos;adaptació a tots els escenaris.
        </p>
                ...
                <div className="ml-20 md:ml-0 md:w-[calc(50%-3rem)]">
                  <div className="rounded-3xl bg-blanco border-4 border-negro shadow-[6px_6px_0_var(--negro)] p-6">
                    <div className="mb-3 flex flex-wrap items-center gap-2">
                      ...
                      >
                        {tipoIcon[hito.tipo]} {tipoLabel[hito.tipo]}
                      </span>
                    </div>
        ...
        >
          <p className="font-display text-2xl font-bold text-blanco italic lg:text-3xl">
            Una banda en plena expansió, llesta per als escenaris de 2026.
          </p>
        </motion.div>
      </div>
    </section>
