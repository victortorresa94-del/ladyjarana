...
export const serviciosES: Record<string, ServicioContent> = {
  bodas: {
    ...
    intro:
      'Lady Jarana es la banda en directo para bodas que convierte una recepción en fiesta mayor. Cuatro músicos profesionales, repertorio bilingüe ES/CA y un show 100% en directo que cubre desde el cóctel hasta la barra libre. Cuarteto desde 1000 €, ideal para bodas en finca, masía, hotel o restaurante en toda Catalunya.',
    eyebrow: 'Bodas',
    ...
    formatoRecomendado:
      'Cuarteto (1000 €) para bodas íntimas o medianas. Quinteto con trompeta (1200 €) si quieres añadir vientos a los temas de rumba.',
    faqs: [
      {
        q: '¿Cuánto cuesta contratar una banda para una boda en Barcelona?',
        a: 'Lady Jarana en formato cuarteto cuesta 1000 €. Quinteto 1200 €. Banda completa desde 1400 €. Sonido propio + 2 técnicos desde 600 € si el venue no tiene PA. Toda Catalunya sin recargo.',
      },
      {
  ...
  'fiestas-mayores': {
    ...
    intro:
      'Lady Jarana es la banda que la plaça estaba esperando. Pop-rock, rumba catalana, latineo y verbeneras en directo para festes majors municipales en toda Catalunya. Formato quinteto con trompeta o banda completa para escenarios XXL. Cuarteto 1000 €, quinteto 1200 €, banda completa desde 1400 €.',
    ...
    formatoRecomendado:
      'Quinteto (1200 €) — formato principal y el más demandado para festes majors. La trompeta marca diferencia en plaza grande. Banda completa (desde 1400 €) para escenarios XXL.',
    faqs: [
      {
        q: '¿Cuánto cobráis para una festa major?',
        a: 'Quinteto 1200 €. Cuarteto 1000 € (suficiente para fiestas menores). Banda completa desde 1400 € para escenarios grandes. Sonido del venue suele estar incluido en festes municipales.',
      },
      {
  ...
  'eventos-privados': {
    ...
    intro:
      'Lady Jarana para aniversarios, cumpleaños grandes, fiestas en finca, fiestas de barrio, celebraciones familiares o cualquier evento privado que merezca banda en directo. Formato flexible desde cuarteto (1000 €), sonido propio opcional si el espacio no tiene equipo. Toda Catalunya sin recargo.',
    ...
    formatoRecomendado:
      'Cuarteto (1000 €) cubre la mayoría de eventos privados. Quinteto con trompeta (1200 €) si quieres añadir el toque festivo de los vientos.',
    faqs: [
      {
        q: '¿Cuánto cuesta una banda para una fiesta privada?',
        a: 'Cuarteto 1000 €, quinteto 1200 €. Si el espacio no tiene equipo de sonido, sumamos PA propio + 2 técnicos desde 600 €. Sin desplazamiento dentro de Catalunya.',
      },
      {
  ...
  'eventos-empresa': {
    ...
    intro:
      'Lady Jarana para cenas corporativas, fin de año, team buildings, inauguraciones, presentaciones de producto y fiestas de empresa en Barcelona y Catalunya. Formato escalable, repertorio adaptable al tono corporativo, profesionalidad para evento de empresa. Cuarteto desde 1000 €.',
    ...
    formatoRecomendado:
      'Cuarteto (1000 €) para cenas y eventos medianos. Quinteto (1200 €) para fiestas grandes de fin de año.',
    faqs: [
      {
        q: '¿Cuánto cuesta contratar una banda para un evento de empresa?',
        a: 'Cuarteto 1000 €, quinteto 1200 €, banda completa desde 1400 €. Sonido propio + técnicos desde 600 € si el espacio no tiene PA. Factura con IVA emitida por 94 Music.',
      },
      {
...
export const serviciosCA: Record<string, ServicioContent> = {
  casaments: {
    ...
    intro:
      'Lady Jarana és el grup en directe per a casaments que converteix una recepció en festa major. Quatre músics professionals, repertori bilingüe ES/CA i un xou 100% en directe que cobreix des del còctel fins a la barra lliure. Quartet des de 1000 €, ideal per a casaments a finca, masia, hotel o restaurant a tota Catalunya.',
    eyebrow: 'Casaments',
    hero: { foto: '/fotos/bodas.jpg', objectPosition: 'center 30%' },
    queHacemos: [
    ...
    formatoRecomendado:
      'Quartet (1000 €) per a casaments íntims o mitjans. Quintet amb trompeta (1200 €) si vols afegir vents als temes de rumba.',
    faqs: [
      {
        q: 'Quant costa contractar un grup per a un casament a Barcelona?',
        a: 'Lady Jarana en format quartet costa 1000 €. Quintet 1200 €. Banda completa des de 1400 €. So propi + 2 tècnics des de 600 € si el venue no té PA. Tota Catalunya sense recàrrec.',
      },
      {
  ...
  'festes-majors': {
    ...
    intro:
      'Lady Jarana és el grup que la plaça estava esperant. Pop-rock, rumba catalana, latineig i revetlleres en directe per a festes majors municipals a tota Catalunya. Format quintet amb trompeta o banda completa per a escenaris XXL. Quartet 1000 €, quintet 1200 €, banda completa des de 1400 €.',
    eyebrow: 'Festes majors',
    hero: { foto: '/fotos/fiestas-mayores.jpg', objectPosition: 'center 40%' },
    queHacemos: [
    ...
    formatoRecomendado:
      'Quintet (1200 €) — format principal i el més demanat per a festes majors. La trompeta marca diferència en plaça gran. Banda completa (des de 1400 €) per a escenaris XXL.',
    faqs: [
      {
        q: 'Quant cobreu per a una festa major?',
        a: 'Quintet 1200 €. Quartet 1000 €. Banda completa des de 1400 €. El so del venue sol estar inclòs en festes municipals.',
      },
      {
  ...
  'esdeveniments-privats': {
    ...
    intro:
      'Lady Jarana per a aniversaris, festes a finca, festes de barri, celebracions familiars o qualsevol esdeveniment privat que mereixi banda en directe. Format flexible des de quartet (1000 €), so propi opcional si l\'espai no té equip. Tota Catalunya sense recàrrec.',
    ...
    formatoRecomendado:
      'Quartet (1000 €) cobreix la majoria d\'esdeveniments privats. Quintet amb trompeta (1200 €) si vols afegir el toc festiu dels vents.',
    faqs: [
      {
        q: 'Quant costa un grup per a una festa privada?',
        a: 'Quartet 1000 €, quintet 1200 €. Si l\'espai no té equip de so, sumem PA propi + 2 tècnics des de 600 €. Sense desplaçament dins de Catalunya.',
      },
      {
  ...
  'esdeveniments-empresa': {
    ...
    intro:
      'Lady Jarana per a sopars corporatius, cap d\'any, team buildings, inauguracions, presentacions de producte i festes d\'empresa a Barcelona i Catalunya. Format escalable, repertori adaptable al to corporatiu, professionalitat per a esdeveniment d\'empresa. Quartet des de 1000 €.',
    ...
    formatoRecomendado:
      'Quartet (1000 €) per a sopars i esdeveniments mitjans. Quintet (1200 €) per a festes grans de cap d\'any.',
    faqs: [
      {
        q: 'Quant costa contractar un grup per a un esdeveniment d\'empresa?',
        a: 'Quartet 1000 €, quintet 1200 €, banda completa des de 1400 €. So propi + tècnics des de 600 € si l\'espai no té PA. Factura amb IVA emesa per 94 Music.',
      },
      {
