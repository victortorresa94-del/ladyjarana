...
export const serviciosES: Record<string, ServicioContent> = {
 ...
 intro:
 'Lady Jarana es la banda en directo para bodas que convierte una recepción en fiesta mayor. Cuatro músicos profesionales, repertorio bilingüe ES/CA y un show 100% en directo que cubre desde el cóctel hasta la barra libre., ideal para bodas en finca, masía, hotel o restaurante en toda Catalunya.',
 eyebrow: 'Bodas',
 ...
 formatoRecomendado:
 'Cuarteto para bodas íntimas o medianas. Quinteto con trompeta si quieres añadir vientos a los temas de rumba.',
 faqs: [
 {
 q: '¿Cuánto cuesta contratar una banda para una boda en Barcelona?',
 a: 'Lady Jarana en formato cuarteto cuesta Quinteto Banda completa Sonido propio + 2 técnicos (presupuesto aparte) si el venue no tiene PA. Toda Catalunya.',
 },
 {
 ...
 intro:
 'Lady Jarana es la banda que la plaça estaba esperando. Pop-rock, rumba catalana, latineo y verbeneras en directo para festes majors municipales en toda Catalunya. Formato quinteto con trompeta o banda completa para escenarios XXL. Cuarteto, quinteto, banda completa',
 ...
 formatoRecomendado:
 'Quinteto — formato principal y el más demandado para festes majors. La trompeta marca diferencia en plaza grande. Banda completa para escenarios XXL.',
 faqs: [
 {
 q: '¿Cuánto cobráis para una festa major?',
 a: 'Quinteto Cuarteto (suficiente para fiestas menores). Banda completa para escenarios grandes. Sonido del venue suele estar incluido en festes municipales.',
 },
 {
 ...
 {
 q: '¿Dónde tocáis?',
 a: 'Toda Catalunya: Barcelona, área metropolitana, Costa Brava, Maresme, Garraf, Vallès, Anoia, Penedès, Osona, Pirineu y todas las comarcas catalanas.',
 },
 ],
 ...
 intro:
 'Lady Jarana para aniversarios, cumpleaños grandes, fiestas en finca, fiestas de barrio, celebraciones familiares o cualquier evento privado que merezca banda en directo. Formato flexible desde cuarteto, sonido propio opcional si el espacio no tiene equipo. Toda Catalunya.',
 ...
 'Si tu espacio (finca, terraza, jardín, local) no tiene PA, llevamos sonido propio con 2 técnicos (presupuesto aparte). Si tienes equipo o el venue lo aporta, mejor para tu bolsillo y nos coordinamos con el técnico que toque.',
 ...
 formatoRecomendado:
 'Cuarteto cubre la mayoría de eventos privados. Quinteto con trompeta si quieres añadir el toque festivo de los vientos.',
 faqs: [
 {
 q: '¿Cuánto cuesta una banda para una fiesta privada?',
 a: 'Cuarteto, quinteto Si el espacio no tiene equipo de sonido, sumamosPA propio + 2 técnicos (presupuesto aparte). Sin desplazamiento dentro de Catalunya.',
 },
 {
 q: '¿Tocáis en fincas y espacios al aire libre?',
 a: 'Sí, frecuentemente. Para espacios sin instalación llevamos sonido propio (Opción B, presupuesto aparte). Necesitamos punto de luz, espacio mínimo para montar el escenario (4×3 metros) y acceso para descarga.',
 },
 {
 ...
 intro:
 'Lady Jarana para cenas corporativas, fin de año, team buildings, inauguraciones, presentaciones de producto y fiestas de empresa en Barcelona y Catalunya. Formato escalable, repertorio adaptable al tono corporativo, profesionalidad para evento de empresa.',
 ...
 formatoRecomendado:
 'Cuarteto para cenas y eventos medianos. Quinteto para fiestas grandes de fin de año.',
 faqs: [
 {
 q: '¿Cuánto cuesta contratar una banda para un evento de empresa?',
 a: 'Cuarteto, quinteto, banda completa Sonido propio + técnicos (presupuesto aparte) si el espacio no tiene PA. Factura con IVA emitida por 94 Music.',
 },
 {
 ...
 a: 'Toda Catalunya. Fuera de Catalunya consultamos desplazamiento, dietas y alojamiento. No cerramos puertas — hemos tocado en otras zonas de España con presupuesto adecuado.',
 },
 ],
...
export const serviciosCA: Record<string, ServicioContent> = {
 ...
 intro:
 'Lady Jarana és el grup en directe per a casaments que converteix una recepció en festa major. Quatre músics professionals, repertori bilingüe ES/CA i un xou 100% en directe que cobreix des del còctel fins a la barra lliure., ideal per a casaments a finca, masia, hotel o restaurant a tota Catalunya.',
 eyebrow: 'Casaments',
 hero: { foto: '/fotos/bodas.jpg', objectPosition: 'center 30%' },
 queHacemos: [
 ...
 formatoRecomendado:
 'Quartet per a casaments íntims o mitjans. Quintet amb trompeta si vols afegir vents als temes de rumba.',
 faqs: [
 {
 q: 'Quant costa contractar un grup per a un casament a Barcelona?',
 a: 'Lady Jarana ofereix quartet, quintet o banda completa. So propi + 2 tècnics si el venue no té PA. Tota Catalunya. Demana pressupost tancat per WhatsApp.',
 },
 {
 ...
 intro:
 'Lady Jarana és el grup que la plaça estava esperant. Pop-rock, rumba catalana, latineig i revetlleres en directe per a festes majors municipals a tota Catalunya. Format quintet amb trompeta o banda completa per a escenaris XXL. Format escalable segons l\'escenari.',
 eyebrow: 'Festes majors',
 hero: { foto: '/fotos/fiestas-mayores.jpg', objectPosition: 'center 40%' },
 queHacemos: [
 ...
 formatoRecomendado:
 'Quintet — format principal i el més demanat per a festes majors. La trompeta marca diferència en plaça gran. Banda completa per a escenaris XXL.',
 faqs: [
 {
 q: 'Quant cobreu per a una festa major?',
 a: 'Quintet (format més demanat per a festes majors), quartet per a festes menors, banda completa per a escenaris grans. El so del venue sol estar inclòs en festes municipals. Demana pressupost per WhatsApp.',
 },
 {
 ...
 {
 q: 'On toqueu?',
 a: 'Tota Catalunya: Barcelona, àrea metropolitana, Costa Brava, Maresme, Garraf, Vallès, Anoia, Penedès, Osona, Pirineu i totes les comarques catalanes.',
 },
 ],
 ...
 intro:
 'Lady Jarana per a aniversaris, festes a finca, festes de barri, celebracions familiars o qualsevol esdeveniment privat que mereixi banda en directe. Format flexible des de quartet, so propi opcional si l\'espai no té equip. Tota Catalunya.',
 ...
 'Si el teu espai (finca, terrassa, jardí, local) no té PA, portem so propi amb 2 tècnics (pressupost a banda). Si tens equip o el venue l\'aporta, millor per a la teva butxaca i ens coordinem amb el tècnic que toqui.',
 ...
 formatoRecomendado:
 'Quartet cobreix la majoria d\'esdeveniments privats. Quintet amb trompeta si vols afegir el toc festiu dels vents.',
 faqs: [
 {
 q: 'Quant costa un grup per a una festa privada?',
 a: 'Quartet, quintet Si l\'espai no té equip de so, sumemPA propi + 2 tècnics (pressupost a banda). Sense desplaçament dins de Catalunya.',
 },
 {
 q: 'Toqueu en finques i espais a l\'aire lliure?',
 a: 'Sí, freqüentment. Per a espais sense instal·lació portem so propi (Opció B, pressupost a banda). Necessitem punt de llum, espai mínim per muntar l\'escenari (4×3 metres) i accés per descàrrega.',
 },
 {
 ...
 intro:
 'Lady Jarana per a sopars corporatius, cap d\'any, team buildings, inauguracions, presentacions de producte i festes d\'empresa a Barcelona i Catalunya. Format escalable, repertori adaptable al to corporatiu, professionalitat per a esdeveniment d\'empresa.',
 ...
 formatoRecomendado:
 'Quartet per a sopars i esdeveniments mitjans. Quintet per a festes grans de cap d\'any.',
 faqs: [
 {
 q: 'Quant costa contractar un grup per a un esdeveniment d\'empresa?',
 a: 'Quartet, quintet o banda completa segons l\'esdeveniment. So propi + tècnics (pressupost a banda) si l\'espai no té PA. Factura amb IVA emesa per 94 Music. Demana pressupost tancat per WhatsApp.',
 },
 {
 ...
 a: 'Tota Catalunya. Fora de Catalunya consultem desplaçament, dietes i allotjament. No tanquem portes.',
 },
 ],
