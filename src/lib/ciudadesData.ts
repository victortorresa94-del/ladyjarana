...
export const ciudadesES: Record<string, CiudadContent> = {
 ...
 intro:
 'Lady Jarana es la banda en directo de Barcelona para bodas, festes majors, eventos privados y empresariales en la ciudad y el área metropolitana. Cuatro músicos profesionales con base en Barcelona, repertorio bilingüe ES/CA y show 100% en directo sin pistas pregrabadas.',
 porQue: [
 ...
 intro:
 'Lady Jarana toca para bodas, festes majors y eventos privados en Girona y toda la provincia: Costa Brava, Empordà, Garrotxa, Cerdanya y Ripollès. Banda de Barcelona con experiencia en fincas y masías de l\'Empordà., show bilingüe ES/CA.',
 porQue: [
 ...
 'Desplazamiento dentro de Catalunya por confirmar en presupuesto.: Barcelona-Girona es una hora.',
 ...
 intro:
 'Lady Jarana es la banda en directo para bodas, festes majors y eventos privados en Tarragona, Reus, Salou, Cambrils y toda la Costa Daurada. Desplazamiento dentro de Catalunya por confirmar en presupuesto.',
 porQue: [
 'Cubrimos toda la Costa Daurada y el interior (Priorat, Conca de Barberà).',
 'Banda con experiencia en espacios al aire libre — opción de sonido propio (PA + 2 técnicos, presupuesto aparte) para fincas y bodas en playa.',
 ...
 intro:
 'Lady Jarana toca en Lleida ciudad, las comarcas del Segrià y l\'Urgell, y los Pirineos. Banda en directo para bodas, festes majors y eventos privados en Ponent y la Catalunya interior.',
 porQue: [
 'Tocamos en Lleida el 27 de junio de 2026 — el salto al circuito catalán más allá del área metropolitana.',
 'Desplazamiento dentro de Catalunya por confirmar en presupuesto. (Barcelona-Lleida ~2 h por autopista).',
...
export const ciudadesCA: Record<string, Omit<CiudadContent, 'porQue' | 'tiposEvento' | 'intro'> & {
 ...
 intro:
 'Lady Jarana és el grup en directe de Barcelona per a casaments, festes majors, esdeveniments privats i empresarials a la ciutat i l\'àrea metropolitana. Quatre músics professionals amb base a Barcelona, repertori bilingüe ES/CA i xou 100% en directe sense pistes pregravades.',
 porQue: [
 ...
 intro:
 'Lady Jarana toca per a casaments, festes majors i esdeveniments privats a Girona i tota la província: Costa Brava, Empordà, Garrotxa, Cerdanya i Ripollès. Grup de Barcelona amb experiència en finques i masies de l\'Empordà., xou bilingüe ES/CA.',
 porQue: [
 ...
 'Desplaçament dins de Catalunya per confirmar al pressupost.: Barcelona-Girona és una hora.',
 ...
 intro:
 'Lady Jarana és el grup en directe per a casaments, festes majors i esdeveniments privats a Tarragona, Reus, Salou, Cambrils i tota la Costa Daurada. Desplaçament dins de Catalunya per confirmar al pressupost.',
 porQue: [
 'Cobrim tota la Costa Daurada i l\'interior (Priorat, Conca de Barberà).',
 'Banda amb experiència en espais a l\'aire lliure — opció de so propi (PA + 2 tècnics, pressupost a banda) per a finques i casaments a la platja.',
 ...
 intro:
 'Lady Jarana toca a Lleida ciutat, les comarques del Segrià i l\'Urgell, i els Pirineus. Grup en directe per a casaments, festes majors i esdeveniments privats a Ponent i la Catalunya interior.',
 porQue: [
 'Toquem a Lleida el 27 de juny de 2026 — el salt al circuit català més enllà de l\'àrea metropolitana.',
 'Desplaçament dins de Catalunya per confirmar al pressupost. (Barcelona-Lleida ~2 h per autopista).',
