...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ladyjarana.es/sobre-lady-jarana',
    languages: {
  ...
  openGraph: {
    ...
    url: 'https://ladyjarana.es/sobre-lady-jarana',
    type: 'profile',
    images: ['/og-image.jpg'],
  },
};
...
const milestones = [
  ...
  { year: '2026 · 11 julio', text: 'Fiesta del Correpintxos en Torregrossa (Pla d\'Urgell), 00:00. Verbena de pueblo en el Ponent.' },
];
...
export default function SobrePage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Sobre Lady Jarana', item: 'https://ladyjarana.es/sobre-lady-jarana' },
    ],
  };
