...
export const metadata: Metadata = {
 ...
 description:
 'Contracta Lady Jarana per al teu casament, festa major o esdeveniment privat a Catalunya. Quartet, quintet o banda completa. Resposta en minuts per WhatsApp.',
 alternates: {
...
const faqs = [
 ...
 a: 'El preu depèn del format (quartet, quintet o banda completa), la data, el lloc i els extres. No fem duo ni trio. Demana pressupost tancat per WhatsApp i et responem en minuts.',
 },
 {
 q: 'Porteu equip de so?',
 a: 'Preferim que el so el posi el venue quan sigui possible. Si no, portem PA propi i 2 tècnics (pressupost a banda) — ideal per a casaments a finca o festes privades sense equip.',
 },
 {
 q: 'On toqueu?',
 a: "Tota Catalunya: Barcelona ciutat, àrea metropolitana, costa catalana i comarques. Fora de Catalunya consultem desplaçament — no tanquem portes, però suma logística.",
 },
 {
 q: 'Canteu en català?',
...
export default function ContractarPage() {
 ...
 >
 {EMAIL}
 </a>. Et responem amb disponibilitat i pressupost en menys de 24 h.
 </p>
 ...
 <p className="mt-1 font-body text-sm text-negro/75">
 Tres formats: quartet, quintet i banda completa. No fem duo ni
 trio.
 </p>
 </div>
 <div className="rounded-2xl border-2 border-negro/15 bg-blanco p-5">
 ...
 <p className="mt-1 font-body text-sm text-negro/75">
 Toquem a tota Catalunya. Fora consultem. Xou
 bilingüe ES/CA.
 </p>
 </div>
 <div className="rounded-2xl border-2 border-negro/15 bg-blanco p-5">
 ...
 <p className="mt-1 font-body text-sm text-negro/75">
 Si el venue té PA i tècnic, perfecte. Si no, t'oferim PA propi + 2 tècnics (pressupost a banda).
 </p>
 </div>
 </div>
