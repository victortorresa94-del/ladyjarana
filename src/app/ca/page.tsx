...
export const metadata: Metadata = {
 ...
 description:
 'Grup de música en directe per a casaments, festes majors i esdeveniments privats a Barcelona i tota Catalunya. Pop-rock català i espanyol, rumba i latineig. Xou bilingüe ES/CA.',
 alternates: {
