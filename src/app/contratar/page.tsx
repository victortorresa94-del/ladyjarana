...
export const metadata: Metadata = {
 ...
 description:
 'Contrata Lady Jarana para tu boda, fiesta mayor o evento privado en Catalunya. Cuarteto, quinteto o banda completa. Respuesta en minutos por WhatsApp.',
 alternates: {
 canonical: '/contratar',
 languages: {
...
const faqs = [
 ...
 a: 'El precio depende del formato (cuarteto, quinteto o banda completa), la fecha, el lugar y los extras. No hacemos dúo ni trío. Pide presupuesto cerrado por WhatsApp y te respondemos en minutos.',
 },
 {
 q: '¿Traéis equipo de sonido?',
 a: 'Preferimos que el sonido lo aporte el venue cuando es posible. Si no, llevamos PA propio y 2 técnicos (presupuesto aparte) — ideal para bodas en finca o fiestas privadas sin equipo.',
 },
 {
 q: '¿Dónde tocáis?',
 a: 'Toda Catalunya: Barcelona ciudad, área metropolitana, costa catalana y comarcas. Fuera de Catalunya consultamos desplazamiento — no cerramos puertas, pero suma logística.',
 },
 {
...
export default function ContratarPage() {
 ...
 <p className="font-body text-sm text-negro/60">
 Tres formatos: cuarteto, quinteto y banda completa. No hacemos dúo ni trío.
 </p>
 </div>
 </div>
 <div className="flex items-start gap-3">
 ...
 <p className="font-body text-sm text-negro/60">
 Tocamos en toda Catalunya. Fuera consultamos. Show bilingüe ES/CA.
 </p>
 </div>
 </div>
 </div>
